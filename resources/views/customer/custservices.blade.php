...
<body>
        ...
        @foreach($services as $service)
            ...
            <div class="card">
                ...
                <div class="caption">
                    ...
                    <p class="category"><i>Category:</i> <br>
                        @if($service->category == 'LivingRoom')
                            Living Room
                        @else
                            {{ $service->category }}
                        @endif
    ...
    if (selectedCategory === 'all') {
        // Redirect to a different route (e.g., 'services' route)
        window.location.href = "{{ route('services') }}";
    } else {
        // Generate the URL based on the selected category
        const url = "{{ route('search-service') }}?category=" + encodeURIComponent(selectedCategory);
