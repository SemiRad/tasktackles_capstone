...
<main>
		...
		<div class="card @if($services->status == 'AVAILABLE') available @elseif($services->status == 'UNAVAILABLE') unavailable @else deleted @endif">
			...
			<p class="cc"><i>Category:</i> <br>{{ $services->category }}</p>
